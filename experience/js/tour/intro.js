...
const soundBtn = document.getElementById('intro-sound') || { textContent: '', setAttribute() {}, addEventListener() {}, removeEventListener() {} };
...
export function runIntro() {
  return new Promise((resolve) => {
    ...
    const onSkip = () => { how = 'skip'; finish(); };
    enter.addEventListener('click', finish); skip.addEventListener('click', onSkip);
    ...
    function cleanup() {
      ...
      enter.removeEventListener('click', finish); skip.removeEventListener('click', onSkip);
